...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			b = element("b");
    			t = text(/*letter*/ ctx[0]);
    			add_location(b, file$4, 7, 8, 143);
    			attr_dev(div0, "class", "letter no-select svelte-1b89dmy");
    			add_location(div0, file$4, 6, 4, 104);
    			attr_dev(div1, "class", div1_class_value = "" + (/*className*/ ctx[1] + " tile" + " svelte-1b89dmy"));
    			add_location(div1, file$4, 5, 0, 69);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*className*/ 2 && div1_class_value !== (div1_class_value = "" + (/*className*/ ctx[1] + " tile" + " svelte-1b89dmy"))) {
    ...
    // (177:4) {#each items as tile (tile.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	tile = new Tile({
    			props: {
    				letter: /*tile*/ ctx[12].letter,
    				className: /*tile*/ ctx[12].letter[0]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const tile_changes = {};
    			if (dirty & /*items*/ 4) tile_changes.letter = /*tile*/ ctx[12].letter;
    			if (dirty & /*items*/ 4) tile_changes.className = /*tile*/ ctx[12].letter[0];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(177:4) {#each items as tile (tile.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const get_key = ctx => /*tile*/ ctx[12].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "square svelte-nu3z2");
    			attr_dev(div, "id", /*id*/ ctx[0]);

    			attr_dev(div, "style", div_style_value = /*items*/ ctx[2].find(/*func*/ ctx[7])
    			? `background: ${background}`
    			: "");

    			add_location(div, file$3, 166, 0, 6388);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "consider", /*handleDndConsider*/ ctx[5], false, false, false, false),
    					listen_dev(div, "finalize", /*handleDndFinalize*/ ctx[6], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*items*/ 4 && div_style_value !== (div_style_value = /*items*/ ctx[2].find(/*func*/ ctx[7])
    			? `background: ${background}`
    			: "")) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $letters,
    		...
    		$$subscribe_letters = () => ($$unsubscribe_letters(), $$unsubscribe_letters = subscribe(letters, $$value => $$invalidate(9, $letters = $$value)), letters);
    	...
    	validate_store(previousId, 'previousId');
    	component_subscribe($$self, previousId, value => $$invalidate(10, $previousId = value));
    	...
    	function handleDndConsider(e) {
    		...
    		if (trigger === TRIGGERS.DRAGGED_LEFT) {
    			...
    			if (previousSquare) previousSquare.style.backgroundColor = "#404040";
    		} else //     $previousIdForOpacity
    		// );
    		...
    		if (trigger !== TRIGGERS.DRAG_STARTED) {
    			if (itemList[0] && itemList[0].letter.toLowerCase() !== "r") {
    				const square = document.getElementById(id + height); // const previousLeftSquare = document.getElementById(
    		...
    		if ($letters[x][y - 1] && ($letters[x][y - 1] === "W" || $letters[x][y - 1] === "B")) {
    	...
    	function handleDndFinalize(e) {
    		...
    		if (e.detail.info.trigger === TRIGGERS.DROPPED_INTO_ZONE) {
    			...
    			if (rightSquare && !isR && (rightSquare.hasChildNodes() || $letters[x][y - 1] === "W" || $letters[x][y - 1] === "B")) rightSquare = false; // to ensure that it's not possible to drag one onto another
    		...
    		} else // console.log(id, $previousId, $previousIdForLetterArray);
    		if (e.detail.info.trigger === TRIGGERS.DROPPED_OUTSIDE_OF_ANY) {
    			const new_letter = e.detail.items[0].letter; // $previousIdForLetterArray = id;

    			const rightSquare = new_letter.toLowerCase() === "r"
    			? false
    	...
    	$$self.$$.on_mount.push(function () {
    		if (id === undefined && !('id' in $$props || $$self.$$.bound[$$self.$$.props['id']])) {
    			console_1$1.warn("<Square> was created without expected prop 'id'");
    		}

    		if (letters === undefined && !('letters' in $$props || $$self.$$.bound[$$self.$$.props['letters']])) {
    			console_1$1.warn("<Square> was created without expected prop 'letters'");
    		}
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('previousId' in $$props) $$invalidate(4, previousId = $$props.previousId);
    		if ('previousIdForOpacity' in $$props) previousIdForOpacity = $$props.previousIdForOpacity;
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h4 = element("h4");
    			t = text(/*id*/ ctx[1]);
    			add_location(h4, file$2, 14, 4, 290);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h4 = element("h4");
    			t = text(/*id*/ ctx[0]);
    			add_location(h4, file$1, 9, 4, 168);
    ...
    function create_each_block_4(ctx) {
    	...
    	function led_ledGrid_binding(value) {
    		/*led_ledGrid_binding*/ ctx[17](value);
    	}

    	let led_props = { id: /*led*/ ctx[26].id };
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const led_changes = {};
    			if (dirty[0] & /*ledGrid*/ 16) led_changes.id = /*led*/ ctx[26].id;
    ...
    function create_each_block_3(ctx) {
    	...
    	function square_letters_binding(value) {
    		/*square_letters_binding*/ ctx[18](value);
    	}

    	let square_props = { id: /*row*/ ctx[32].id };
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$boardGrid*/ 64) square_changes.id = /*row*/ ctx[32].id;
    ...
    function create_each_block_1(ctx) {
    	...
    	function ledout_ledGridOut_binding(value) {
    		/*ledout_ledGridOut_binding*/ ctx[19](value);
    	}

    	let ledout_props = { id: /*led*/ ctx[26].id };
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*ledGridOut*/ 4) ledout_changes.id = /*led*/ ctx[26].id;
    ...
    function create_each_block(key_1, ctx) {
    	...
    	tile = new Tile({
    			props: {
    				letter: /*item*/ ctx[23].letter,
    				className: /*item*/ ctx[23].letter[0]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const tile_changes = {};
    			if (dirty[0] & /*items*/ 1) tile_changes.letter = /*item*/ ctx[23].letter;
    			if (dirty[0] & /*items*/ 1) tile_changes.className = /*item*/ ctx[23].letter[0];
    			tile.$set(tile_changes);
    		},
    		r: function measure() {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window_1, "keydown", /*run*/ ctx[14], false, false, false, false),
    					listen_dev(button0, "click", /*decrementBoardGridLength*/ ctx[13], false, false, false, false),
    					listen_dev(button1, "click", /*decrementBoardGridHeight*/ ctx[11], false, false, false, false),
    					listen_dev(button2, "click", /*incrementBoardGridLength*/ ctx[12], false, false, false, false),
    					listen_dev(button3, "click", /*incrementBoardGridHeight*/ ctx[10], false, false, false, false),
    					...
    					listen_dev(div5, "consider", /*handleDndConsider*/ ctx[8], false, false, false, false),
    					listen_dev(div5, "finalize", /*handleDndFinalize*/ ctx[9], false, false, false, false),
    					listen_dev(button4, "click", /*run*/ ctx[14], false, false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let $letters,
    		$$unsubscribe_letters = noop,
    		$$subscribe_letters = () => ($$unsubscribe_letters(), $$unsubscribe_letters = subscribe(letters, $$value => $$invalidate(22, $letters = $$value)), letters);
    	...
    	validate_store(length, 'length');
    	component_subscribe($$self, length, value => $$invalidate(16, $length = value));
    	let height = 5;
    	...
    	let letters = writable(Array.from({ length: height }, () => Array.from({ length: $length }, () => "X")));
    	validate_store(letters, 'letters');
    	$$subscribe_letters();
    	...
    	function incrementBoardGridLength(_e) {
    		set_store_value(length, $length += 1, $length);
    	...
    	function run(e) {
    		...
    		const code = $letters.map((col, idx) => col.map((element, jdx) => {
    			...
    			if (prevElement === "W" || prevElement === "B") return prevElement; else return element;
    		})).join("\n").replaceAll(",", " ");
    	...
    	let ledGridOut = Array.from({ length: $length }, (_, i) => Object.create({ id: i, isOn: false }));
    	...
    	function led_ledGrid_binding(value) {
    		ledGrid = value;
    		($$invalidate(4, ledGrid), $$invalidate(16, $length));
    	}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*$length, height*/ 98304) {
    			$$subscribe_boardGrid($$invalidate(5, boardGrid = writable(Array.from({ length: $length }, (_, i) => Array.from({ length: height }, (_, j) => ({ id: i * height + j }))))));
    		}

    		if ($$self.$$.dirty[0] & /*$length*/ 65536) {
    			// of type { id: number, isOn: bool}
    			$$invalidate(4, ledGrid = Array.from({ length: $length }, (_, i) => Object.create({ id: i, isOn: false })));
    		}
